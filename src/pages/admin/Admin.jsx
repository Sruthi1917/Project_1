...
const Admin = () => {
  ...
  const fetchCountData = async () => {
    await axios
      .get("http://localhost:6001/api/users/fetch-users")
      .then((response) => {
    ...
    await axios
      .get("http://localhost:6001/api/orders/fetch-orders")
      .then((response) => {
  ...
  const updateBanner = async () => {
    try {
      await axios.put("http://localhost:6001/api/banners/banner", { banner });
